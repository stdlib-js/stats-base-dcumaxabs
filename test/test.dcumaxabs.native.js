...
tape( 'the function has an arity of 5', opts, function test( t ) {
	t.strictEqual( dcumaxabs.length, 5, 'has expected arity' );
	t.end();
});

tape( 'the function computes the cumulative maximum absolute value', opts, function test( t ) {
	var expected;
	var x;
	var y;
	var i;
...
tape( 'the function returns a reference to the output array', opts, function test( t ) {
	...
	out = dcumaxabs( x.length, x, 1, y, 1 );
